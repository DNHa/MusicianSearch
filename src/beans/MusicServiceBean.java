...
public class MusicServiceBean {
	...
	public void onRowSelect(SelectEvent event) {
		...
		setVideosURLs(sh.createVideosURLs(artist.getId()));
	}
	...
	public VideosURLs getVideosURLs() {
		return videosURLs;
	}

	public void setVideosURLs(VideosURLs videosURLs) {
